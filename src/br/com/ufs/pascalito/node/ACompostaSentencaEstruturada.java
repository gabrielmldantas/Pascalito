...
public final class ACompostaSentencaEstruturada extends PSentencaEstruturada
{
    private PSentencaComposta _sentencaComposta_;

    public ACompostaSentencaEstruturada()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACompostaSentencaEstruturada(
    ...
    {
        ((Analysis) sw).caseACompostaSentencaEstruturada(this);
    }
