...
public final class APrimitivoTipoIdOuPrimitivo extends PTipoIdOuPrimitivo
{
    private PTipoPrimitivo _tipoPrimitivo_;

    public APrimitivoTipoIdOuPrimitivo()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrimitivoTipoIdOuPrimitivo(
    ...
    {
        ((Analysis) sw).caseAPrimitivoTipoIdOuPrimitivo(this);
    }
