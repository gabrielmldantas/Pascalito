...
public final class AUnicoCabecalhoPrograma extends PCabecalhoPrograma
{
    private TProgram _program_;
    private TIdentificador _identificador_;

    public AUnicoCabecalhoPrograma()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUnicoCabecalhoPrograma(
    ...
    {
        ((Analysis) sw).caseAUnicoCabecalhoPrograma(this);
    }
