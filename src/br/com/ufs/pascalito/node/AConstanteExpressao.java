...
public final class AConstanteExpressao extends PExpressao
{
    private PConstante _constante_;

    public AConstanteExpressao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConstanteExpressao(
    ...
    {
        ((Analysis) sw).caseAConstanteExpressao(this);
    }
