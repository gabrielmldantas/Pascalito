...
public final class ASentencaComposta extends PSentencaComposta
{
    private TBegin _begin_;
    private PSequenciaSentencas _sequenciaSentencas_;
    private TEnd _end_;

    public ASentencaComposta()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseASentencaComposta(this);
    }
