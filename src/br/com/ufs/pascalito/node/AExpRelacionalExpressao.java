...
public final class AExpRelacionalExpressao extends PExpressao
{
    ...
    public Object clone()
    {
        return new AExpRelacionalExpressao(
    ...
    {
        ((Analysis) sw).caseAExpRelacionalExpressao(this);
    }
