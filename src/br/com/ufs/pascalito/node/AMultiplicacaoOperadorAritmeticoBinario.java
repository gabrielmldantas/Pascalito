...
public final class AMultiplicacaoOperadorAritmeticoBinario extends POperadorAritmeticoBinario
{
    private TMultiplicacao _multiplicacao_;

    public AMultiplicacaoOperadorAritmeticoBinario()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMultiplicacaoOperadorAritmeticoBinario(
    ...
    {
        ((Analysis) sw).caseAMultiplicacaoOperadorAritmeticoBinario(this);
    }
