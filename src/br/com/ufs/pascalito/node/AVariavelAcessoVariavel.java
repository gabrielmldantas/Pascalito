...
public final class AVariavelAcessoVariavel extends PAcessoVariavel
{
    private PVariavel _variavel_;

    public AVariavelAcessoVariavel()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVariavelAcessoVariavel(
    ...
    {
        ((Analysis) sw).caseAVariavelAcessoVariavel(this);
    }
