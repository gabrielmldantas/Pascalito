...
public final class ARealIdentificadorTipoOrdinal extends PIdentificadorTipoOrdinal
{
    private TReal _real_;

    public ARealIdentificadorTipoOrdinal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ARealIdentificadorTipoOrdinal(
    ...
    {
        ((Analysis) sw).caseARealIdentificadorTipoOrdinal(this);
    }
