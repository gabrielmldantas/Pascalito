...
public interface Analysis extends Switch
{
    ...
    void caseASimplesSentenca(ASimplesSentenca node);
    void caseAEstruturadaSentenca(AEstruturadaSentenca node);
    ...
    void caseAEstruturadaFechadaDefinicaoSentenca(AEstruturadaFechadaDefinicaoSentenca node);
    void caseASimplesDefinicaoSentencaFechada(ASimplesDefinicaoSentencaFechada node);
    void caseAEstruturadaDefinicaoSentencaFechada(AEstruturadaDefinicaoSentencaFechada node);
    void caseADefinicaoSentencaSimples(ADefinicaoSentencaSimples node);
    void caseADefinicaoSentencaEstruturada(ADefinicaoSentencaEstruturada node);
    void caseADefinicaoSentencaEstruturadaFechada(ADefinicaoSentencaEstruturadaFechada node);
    ...
    void caseAIfSentencaEstruturada(AIfSentencaEstruturada node);
    void caseACompostaSentencaEstruturadaFechada(ACompostaSentencaEstruturadaFechada node);
    void caseAWhileSentencaEstruturadaFechada(AWhileSentencaEstruturadaFechada node);
    void caseASentencaWhile(ASentencaWhile node);
    void caseAEstruturadaSentencaWhile(AEstruturadaSentencaWhile node);
    void caseASentencaWhileFechada(ASentencaWhileFechada node);
    void caseASentencaGoto(ASentencaGoto node);
    void caseASentencaIf(ASentencaIf node);
    void caseAElseSentencaIf(AElseSentencaIf node);
    void caseAIfSentencaIfFechada(AIfSentencaIfFechada node);
    void caseASentencaIfFechada(ASentencaIfFechada node);
